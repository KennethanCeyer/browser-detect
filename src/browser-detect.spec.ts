...
describe('test method: browser()', () => {
    it('detect: Chrome on Windows 10', () => {
    ...
    it('detect: Internet Explorer 11.0 on Windows 10', () => {
    ...
    it('detect: Firefox on Windows 10', () => {
    ...
    it('detect: Safari on iPhone 6 (Mobile)', () => {
    ...
    it('detect: Chrome on Galaxy S5 (Mobile)', () => {
